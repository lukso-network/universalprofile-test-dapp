...
test('can send transaction from preset', async () => {
  ...
  mockEncodeParameters.mockReturnValueOnce('000000000000000000000000517216362d594516c6f96ee34b2c502d65b847e40000000000000000000000000000000000000000000000056bc75e2d63100000')
  ...
  await waitFor(() => {
    expect(screen.getByTestId('function-call')).toHaveValue('mint(address to, uint256 amount)')
  })

  expect(utils.emitted()['update:data']).toEqual([['0x40c10f190000000000000000000000517216362d594516c6f96ee34b2c502d65b847e40000000000000000000000000000000000000000000000056bc75e2d63100000']])
})
