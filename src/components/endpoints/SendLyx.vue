...
const sampleData: { [key: string]: TransactionSelect[] } = {
  LYX: [
    ...
    {
      label: 'Transfer: token to EoA with test data',
      to: '0x311611C9A46a192C14Ea993159a0498EDE5578aC',
      amount: 0.1,
      hasData: true,
  ...
  ERC20: [
    ...
    {
      label: 'Transfer: 1 token to EoA (without EIP165)',
  ...
  ERC777: [
    ...
    {
      label: 'Transfer: 1 token to EoA (without EIP165)',
      to: '0x1FC97E73C4b96299848C943C51e8CD0375a5B63B',
      amount: 0,
      hasData: true,
      data: '',
    },
