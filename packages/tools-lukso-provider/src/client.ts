...
interface UPClientProvider {
	 ...
	 */
	listeners<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
	): Array<EventEmitter.EventListener<UPClientProviderEvents, T>>;
	 ...
	 */
	emit<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		...args: EventEmitter.EventArgs<UPClientProviderEvents, T>
	): boolean;

	/**
	 * Add a listener for a given event.
	 */
	on<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		fn: EventEmitter.EventListener<UPClientProviderEvents, T>,
		context?: any,
	): this;
	addListener<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		fn: EventEmitter.EventListener<UPClientProviderEvents, T>,
		context?: any,
	): this;
	 ...
	 */
	once<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		fn: EventEmitter.EventListener<UPClientProviderEvents, T>,
		context?: any,
	): this;
	 ...
	 */
	removeListener<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		fn?: EventEmitter.EventListener<UPClientProviderEvents, T>,
		context?: any,
		once?: boolean,
	): this;
	off<T extends EventEmitter.EventNames<UPClientProviderEvents>>(
		event: T,
		fn?: EventEmitter.EventListener<UPClientProviderEvents, T>,
		context?: any,
		once?: boolean,
	 ...
	 */
	removeAllListeners(
		event?: EventEmitter.EventNames<UPClientProviderEvents>,
	): this;
...
async function testWindow(
	up: Window | undefined | null,
	remote: UPClientProvider,
	options: UPClientProviderOptions,
): Promise<UPClientProvider> {
...
function createClientUPProvider(
	...
	const doSearch = async (client: JSONRPCClient): Promise<UPClientProvider> => {
		...
		searchPromise = findDestination(authURL, remote, options, search).then(
			(up) => {
				const init:
					| {
							chainId: number;
